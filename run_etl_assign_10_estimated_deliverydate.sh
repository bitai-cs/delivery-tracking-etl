...
YESTERDAY_LOG="cron_etl_assign_10_estimated_deliverydate_$(date -d "yesterday" +'%Y%m%d').log"
...
LOG_FILE="cron_etl_assign_10_estimated_deliverydate_$(date +'%Y%m%d').log"
...
poetry run etl_assign_10_estimated_deliverydate