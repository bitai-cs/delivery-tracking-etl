...
def extract_data():
    ...
    date_with_margin = datetimeFromTimeZone - timedelta(days=DT_CONFIG['DAYSOFMARGIN_EMBARKEDTODESTINATIONDATE'])
...
def update_data(data, recordCount):
    ...
    for row in data:
        ...
        if cursor.rowcount > 0:
            ...
            print("No se actualizó a campo EMBARCADO_HACIA_DESTINO.")
        ### END IF ###
        print("-------------------------------------------------------------------")
    ### END FOR LOOP ###
...
def main():
    logger.printInfo("ASSIGN_13_EMBARKED_TO_ DESTINATION STARTING...")
    try:
        ...
        logger.printInfo("ASSIGN_13_EMBARKED_TO_ DESTINATION FINISHED.")
    except mysql.connector.Error as e:
        logger.printError("Error en MySql!")
        logger.printException(e)
        logger.printInfo("ASSIGN_13_EMBARKED_TO_ DESTINATION FINISHED W/ ERRORS.")
