...
YESTERDAY_LOG="cron_etl_assign_17_disembarked_at_destination_$(date -d "yesterday" +'%Y%m%d').log"
...
LOG_FILE="cron_etl_assign_17_disembarked_at_destination_$(date +'%Y%m%d').log"
...
poetry run etl_assign_17_disembarked_at_destination